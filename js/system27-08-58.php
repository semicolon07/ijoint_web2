...
$chkAuthen = md5($_SESSION['UserCode']);
...
function roleChkData(){
    ...
    function stepConfig(e,f){
        var $chkfixStep = $("input[name='chkfixStep[]'][type='checkbox']:checked");
        var $chkStep = "";
...
//RFC zone
    ...
    function newRFCSave(e,f,step){
        ...
        if(chkModule==true){
            ...
            if(varUid==''?  varUid = '<?=$_SESSION['UserCode'];?>':varUid );
            ...
            if(step=='NW'){
                ...
                $.post("mainRFC/rfcSaveAction.php",{
                        ...
                        nStep: step,
                        ptImpGrp: $('#tImpGrp').val(),
                        ptImpPlan: $('#tImpPlan').val(),
                        ptBackOut: $('#tBackOut').val(),
                        ptChgTest: $('#tChgTest').val(),
    ...
    function reqDataNW(){
        if($('#tNname').val()=='' || $('#tReqDetail').val()=='' || $('#tResonChg').val()=='' ){
    ...
    function reqDataPM(){
        if($('#tNname').val()=='' || $('#txtPcode').val()=='' || $('#tsystem').val()=='' || $('#tlang').val()=='' || $('#ttypereq').val()==''){
            if($('#tNname').val()==''){ $('#tNname').css("border", "solid thin #ED0000");  }else{ $('#tNname').css("border", "solid thin #d2d6de"); }
    ...
    function reqDataCM(){
        if($('#tNname').val()=='' || $('#timpGrp').val()=='' || $('#ConfigImpact').val()==''){
            if($('#tNname').val()==''){ $('#tNname').css("border", "solid thin #ED0000");  }else{ $('#tNname').css("border", "solid thin #d2d6de"); }
    ...
    function reqDataSA(){
        if($('#tNname').val()=='' || $('#tImpGrp').val()=='' || $('#tConfChg').val()=='' || $('#tFullDetail').val()==''|| $('#tCSStartSA').val()==''|| $('#tCSFinSA').val()==''|| $('#effHourSA').val()==''|| $('#effMinuteSA').val()==''){
            if($('#tNname').val()==''){ $('#tNname').css("border", "solid thin #ED0000");  }else{ $('#tNname').css("border", "solid thin #d2d6de"); }
            if($('#tImpGrp').val()==''){ $('#tImpGrp').css("border", "solid thin #ED0000");  }else{ $('#tImpGrp').css("border", "solid thin #d2d6de"); }
    ...
    function reqDataPG(){
        if($('#tNname').val()=='' || $('#tCSStartPG').val()=='' || $('#tCSFinPG').val()=='' || $('#effHourPG').val()==''|| $('#effMinutePG').val()==''){
            if($('#tNname').val()==''){ $('#tNname').css("border", "solid thin #ED0000");  }else{ $('#tNname').css("border", "solid thin #d2d6de"); }
    ...
    function reqDataQC(){
        if($('#tNname').val()=='' || $('#effHourQC').val()=='' || $('#effMinuteQC').val()=='' || $('#testreview_no').val()==''|| $('#review_item').val()==''|| $('#testdefect_no').val()==''|| $('#test_item').val()==''){
            if($('#tNname').val()==''){ $('#tNname').css("border", "solid thin #ED0000");  }else{ $('#tNname').css("border", "solid thin #d2d6de"); }
    ...
    function reqDataQA(){
        if($('#tNname').val()=='' || $('#effHourQA').val()=='' || $('#effMinuteQA').val()=='' || $('#testreview_no').val()==''|| $('#review_item').val()==''|| $('#testdefect_no').val()==''|| $('#test_item').val()==''){
            if($('#tNname').val()==''){ $('#tNname').css("border", "solid thin #ED0000");  }else{ $('#tNname').css("border", "solid thin #d2d6de"); }
